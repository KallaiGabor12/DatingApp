...
const AppSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className={`py-8 flex  ${
          !isExpanded && !isHovered ? "lg:justify-between" : "justify-start"
        }`}
      >
      ...
      <div className="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        ...
        <div className="flex flex-col gap-4 mb-4">
            <div>
              {renderMenuItems(welcomeNavItems, "main")}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div>
              <h2
                className={`mb-2 mt-4 text-xs uppercase flex leading-[20px] text-gray-400 ${
                  !isExpanded && !isHovered
                    ? "lg:justify-center"
                    : "justify-start"
                }`}
